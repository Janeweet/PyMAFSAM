# This script is borrowed and modified from https://github.com/HongwenZhang/PyMAF/core/train_options.py
...
class TrainOptions():
    def __init__(self):
        ...
        train.add_argument('--regressor', type=str, default='pymaf_net', help='Name of the SMPL regressor.')
        ...
        train.add_argument('--single_dataname', type=str, default='lspet', help='Name of the single dataset.')
        ...
        train.add_argument("--local_rank", default=0, type=int) # local gpu ID
